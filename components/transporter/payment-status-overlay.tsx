...
/**
 * Full-screen overlay shown while a subscription payment is being confirmed.
 *
...
export function PaymentStatusOverlay({ controlNumber, statusMessage, onDone }: PaymentStatusOverlayProps) {
