                        ...
                        <div className="flex flex-wrap gap-2 w-full">
                          {labels.map((label, i) => (
                            <Link key={i} href={links[i] || links[0]} className="flex-none">
                              <Button
                                size="sm"
                                className={`w-auto h-7 md:h-10 text-[9px] md:text-sm font-bold rounded-lg md:rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all group px-3 md:px-6 ${
                                  i === 0
              ...
              {allSlides.map((_, index) => (
                <button
                  ...
                  className={`h-1.5 sm:h-2 rounded-full transition-all duration-300 ${
                    index === currentSlide ? "bg-primary w-6 sm:w-8" : "bg-white/40 w-1.5 sm:w-2 hover:bg-white/60"
                  }`}
