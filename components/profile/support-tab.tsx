...
export default function SupportTab({ tickets }: SupportTabProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>Describe your issue and we'll connect you with an agent.</DialogDescription>
            </DialogHeader>
      ...
      {tickets.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center text-zinc-500">You don't have any support tickets yet.</CardContent>
        </Card>
      ) : (
