          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl bg-teal-800/40 flex items-center justify-center hover:bg-white hover:text-teal-900 transition-all duration-300 group">
                  <social.icon className="h-5 w-5 opacity-50 group-hover:opacity-100" />
                </a>
              ))}
              <a href="https://www.tiktok.com/@tolatola.inc?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-xl bg-teal-800/40 flex items-center justify-center hover:bg-white hover:text-teal-900 transition-all duration-300 group">
