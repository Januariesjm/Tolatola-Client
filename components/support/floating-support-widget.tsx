...
export function FloatingSupportWidget() {
  ...
  return (
    <>
      ...
      {isOpen && <div className="fixed inset-0 z-40 bg-black/20 backdrop-blur-[1px] transition-opacity" onClick={() => setIsOpen(false)} />}
                ...
                >
                    ...
                    <div className="my-1">
                      {msg.attachmentType?.startsWith("image/") || msg.attachmentUrl.startsWith("data:image/") ? (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="truncate text-xs font-bold">{msg.attachmentName || "PDF Document"}</p>
                  ...
                  <span
                    className={`text-[10px] block ${
                      msg.sender === "user" ? "text-blue-100 text-right" : msg.sender === "agent" ? "text-emerald-500" : "text-slate-400"
                    }`}
                  >
                    {msg.timestamp}
                  </span>
