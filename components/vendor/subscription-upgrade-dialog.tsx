...
/**
 * The subscription upgrade dialog for the vendor subscription tab.
 *
 ...
 * components/transporter/subscription-upgrade-dialog.tsx (same three payment
 * sections), but the header copy and the plan-summary labels differ per tab,
 * so it is kept separate rather than parameterizing one shared component with
 * more text props.
 */
...
export interface VendorSubscriptionUpgradeDialogProps {
  open: boolean
...
export function VendorSubscriptionUpgradeDialog({
  open,
  onOpenChange,
  selectedPlan,
  paymentMethod,
  ...
  upgrading,
  onUpgrade,
}: VendorSubscriptionUpgradeDialogProps) {
  return (
