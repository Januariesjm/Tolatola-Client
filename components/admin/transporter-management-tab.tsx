    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="relative overflow-hidden rounded-xl border border-blue-100 bg-white p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-blue-600 tabular-nums">{transporters.filter((t) => t.kyc_status === "approved").length}</p>
        </div>
              ...
              >
                ...
                <div className="px-5 py-3 space-y-2">
                  ...
                  <div className="flex items-center gap-2.5 text-xs text-slate-600">
                    ...
                    <span>
                      KYC: <span className="font-medium capitalize">{transporter.kyc_status || "pending"}</span>
                    </span>
                  </div>
                  <div className="flex items-center gap-2.5 text-xs text-slate-600">
                    <Truck className="h-3.5 w-3.5 text-slate-400 shrink-0" />
                    <span>
                      Plate: <span className="font-medium font-mono">{transporter.vehicle_registration || "N/A"}</span>
                    </span>
                  </div>
                  <div className="flex items-center gap-2.5 text-xs text-slate-600">
