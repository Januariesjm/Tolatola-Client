 ...
 */
export function ValidationSurveysImportWizard({
  open,
  onClose,
  onImported,
}: ValidationSurveysImportWizardProps) {
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[85vh] animate-[scale-up_0.2s_ease-out]">
            ...
            <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
              ...
              <div className="flex gap-2">
                ...
                {importStep === 3 && (
                  <Button variant="default" size="sm" onClick={executeBulkImport} disabled={isImporting} className="rounded-xl bg-primary text-white hover:bg-primary/95 transition">
