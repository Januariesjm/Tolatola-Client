...
export const metadata: Metadata = {
  ...
  description:
    "Transparency, trust, and security. Learn how Tola protects your data and ensures a safe trading environment for all Tanzanian entrepreneurs and consumers.",
  alternates: {
  ...
  const sections = [
    {
      ...
      content:
        "At TOLA, we believe your data is your own. We collect only what is necessary to facilitate secure trade and provide you with a seamless Digital trade and Supply Chain Ecosystem experience within the Tanzanian digital landscape.",
    },
    {
      title: "Consent & Usage",
      icon: <Fingerprint className="h-8 w-8 text-primary" />,
      content:
        "By using our platform, you explicitly consent to the collection of transactional and profile data. We use this strictly for order fulfillment, fraud prevention, and platform optimization. We never sell your data to third parties.",
    },
    {
      title: "Secure Financial Safety",
      icon: <Lock className="h-6 w-6" />,
      content:
        "Our integrated payment system ensures that financial data is handled with the highest level of security. We partner with verified mobile money providers (M-Pesa, Tigo Pesa, Airtel Money) to maintain a transparent audit trail.",
    },
    {
      title: "KYC Compliance",
      icon: <ShieldAlert className="h-8 w-8 text-primary" />,
      content:
        "For the safety of our ecosystem, we verify vendor identities through NIDA and TIN validation. This minimizes risk and builds a Digital trade and Supply Chain Ecosystem of verified, trustworthy professionals.",
    },
  ]
        ...
        <section className="relative py-16 md:py-24 bg-stone-950 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tight">
              Your Privacy, <span className="text-primary italic">Our Core</span>
            </h1>
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="space-y-12">
              <div>
                <h2 className="text-2xl md:text-3xl font-black mb-4 border-l-4 border-primary pl-6 tracking-tight">
                  Personal Data Collection
                </h2>
                <div className="space-y-4 text-muted-foreground text-base leading-relaxed">
                  <p>
                    We collect identifiable information such as your <strong>Full Name, Email, Phone Number, and Delivery Address</strong>.
                    This data is used solely to facilitate the Digital trade and Supply Chain Ecosystem lifecycle.
                  </p>
                  <p>
                    For vendors, our <strong>KYC Process</strong> requires Tax Identification Numbers (TIN) and National ID (NIDA) data.
                    This information is stored in encrypted offshore and local servers to ensure maximum resilience and compliance.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-black mb-4 border-l-4 border-primary pl-6 tracking-tight">
                  Third-Party Safeguard
                </h2>
                <div className="space-y-4 text-muted-foreground text-base leading-relaxed">
                  <p>
                    We partner with leading payment processors and logistics entities. Data shared with these partners is restricted to the
                    bare minimum required for execution (e.g., sharing your address with a delivery transporter).
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 container mx-auto px-4">
          <div className="bg-stone-900 rounded-[2.5rem] p-8 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-stone-400 text-lg mb-8 italic max-w-xl mx-auto">
                Our Data Protection Officer is available for any inquiries regarding your information.
              </p>
              <a
                href="mailto:privacy@tolatola.co"
                className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-white rounded-2xl font-black text-lg shadow-xl hover:scale-105 transition-all"
              >
