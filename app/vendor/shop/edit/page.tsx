...
const log = logger.child("app.vendor.shop.edit")
  ...
  useEffect(() => {
    const fetchShopData = async () => {
      try {
        ...
        log.error("failed to load shop", err)
      } finally {
            ...
            <Card className="border-none shadow-2xl shadow-stone-200/50 rounded-[2.5rem] overflow-hidden">
              ...
              <CardContent className="p-10 space-y-8">
                <div className="space-y-3">
                  <Label htmlFor="name" className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400 ml-1">
                    Shop Name *
                  </Label>
                  <Input
                    id="name"
                ...
                <div className="space-y-3">
                  <Label htmlFor="description" className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400 ml-1">
                    Description
                  </Label>
                  <Textarea
                    id="description"
            ...
            <Card className="border-none shadow-2xl shadow-stone-200/50 rounded-[2.5rem] overflow-hidden">
              <CardHeader className="p-10 pb-0">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#2563EB]/60 ml-9">Required for Delivery Mapping</p>
                </div>
              </CardHeader>
