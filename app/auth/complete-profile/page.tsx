        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="backdrop-blur-sm bg-card/95 shadow-xl border-primary/10">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-base">Select how you want to use TOLA to continue.</CardDescription>
              {userEmail && (
                  ...
                  <div className="grid gap-4">
                    ...
                    >
                      <div className="flex items-center space-x-3 p-4 rounded-xl border border-stone-100 hover:border-primary/50 hover:bg-primary/5 transition-all cursor-pointer group">
                        ...
                        <Label
                          htmlFor="customer"
                          className="font-bold cursor-pointer flex-1 text-stone-700 group-hover:text-primary transition-colors capitalize"
                        >
                          shop for products
                        </Label>
                      </div>
          ...
          <p className="text-center text-xs text-stone-400">By continuing, you agree to our Terms of Service and Privacy Policy.</p>
        </div>
      </div>
    </div>
  )
