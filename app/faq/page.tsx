      ...
      questions: [
        {
          ...
          a: "Click on 'Sign Up' in the top right corner, fill in your details including email, password, and phone number. You'll receive a confirmation email to verify your account.",
        },
        {
          q: "What payment methods do you accept?",
          a: "We accept M-Pesa, Tigo Pesa, and Airtel Money. All payments are processed through our secure payment system to protect both buyers and sellers.",
        },
        {
          q: "How does the payment protection work?",
          a: "When you make a purchase, your payment is held securely by a licensed PSP. The funds are only released to the vendor after you confirm that you've received your order. This protects you from fraud and ensures you get what you paid for.",
        },
        {
          q: "What if I don't receive my order?",
          a: "If you don't receive your order within the expected timeframe, contact our support team. Since your payment is securely held, we can investigate and issue a refund if necessary.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          a: "Click 'Become a Vendor' on the homepage, create an account, and complete the KYC verification process. You'll need to provide your TIN, NIDA, and business license. Once approved, you can start listing products.",
        },
        {
          q: "What documents do I need for KYC?",
          a: "You need: (1) Tax Identification Number (TIN), (2) National ID (NIDA), and (3) Business License. All documents must be valid and clearly legible.",
        },
        {
          q: "When do I receive payment for my sales?",
          a: "Payments are released after the buyer confirms delivery. You can then request a payout to your mobile money account. Payouts are typically processed within 24-48 hours.",
        },
        {
          q: "What are the fees for selling?",
          a: "We charge a small maintanance fee on each sale to maintain the platform. There are no upfront fees or monthly subscription charges.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          q: "Is my data secure on Tola?",
          a: "Yes. We use industry-standard encryption and secure servers to protect all your personal and financial information.",
        },
        {
          q: "How do you verify vendors?",
          a: "Every vendor must undergo a rigorous KYC (Know Your Customer) process, verifying their government-issued IDs and business documentation before they can sell.",
        },
      ],
    },
  ]
            ...
            {faqCategories.map((category, catIdx) => (
              <div key={catIdx} className="space-y-12">
                <div className="flex items-center gap-6 border-l-8 border-primary pl-8">
                  <div className="p-4 rounded-2xl bg-primary text-white shadow-lg shadow-primary/20">{category.icon}</div>
        ...
        <section className="py-24 bg-stone-900 overflow-hidden relative">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <a
                href="/contact"
                className="flex items-center gap-3 px-10 py-5 bg-white text-stone-900 rounded-2xl font-black shadow-2xl hover:scale-105 transition-all"
              >
              ...
              <a
                ...
                className="flex items-center gap-3 px-10 py-5 bg-white/5 border border-white/10 text-white rounded-2xl font-black backdrop-blur-md hover:bg-white/10 transition-all"
              >
