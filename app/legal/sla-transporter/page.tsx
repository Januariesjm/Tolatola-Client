                        ...
                        <CardContent className="p-6 md:p-10 space-y-8 text-stone-700 leading-relaxed">
                            ...
                            <section className="space-y-4">
                                ...
                                <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                                    ...
                                    <p className="text-sm">A <strong>10% fee</strong> is deducted from the transaction value for coordination, matching, and tracking services. This is processed automatically via the PSP.</p>
                                </div>
                            </section>
