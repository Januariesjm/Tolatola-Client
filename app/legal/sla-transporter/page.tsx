      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-4 text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-black text-stone-900 tracking-tight">Service Level Agreement</h1>
            <p className="text-lg md:text-xl text-stone-600 font-medium">For Transporters / Logistics Partners</p>
          </div>
            ...
            <CardContent className="p-6 md:p-10 space-y-8 text-stone-700 leading-relaxed">
              <section className="space-y-4">
                ...
                <div className="p-4 bg-stone-50 rounded-lg border border-stone-100 text-sm">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      <strong>TOLA Digital Trade & Supply Chain Ecosystem</strong> – a Digital Trade & Supply Chain Ecosystem ("TOLA")
                    </li>
                    <li>
                      <strong>Transporter / Logistics Partner</strong> (the "Transporter")
                    </li>
                  </ul>
                  <p className="mt-2">
                    This SLA defines the service standards, roles, responsibilities, rights, and obligations governing the participation of
                    Transporters on the TOLA Digital Trade & Supply Chain Ecosystem.
                  </p>
                </div>
              </section>
              ...
              <section className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <strong className="text-stone-900">TOLA Digital Trade & Supply Chain Ecosystem:</strong> A digital platform that
                    orchestrates trade, logistics, and transaction data without holding or controlling funds.
                  </li>
                  <li>
                    <strong className="text-stone-900">Transporter:</strong> A logistics or transportation service provider onboarded on the
                    TOLA Digital Trade & Supply Chain Ecosystem.
                  </li>
                  <li>
                    <strong className="text-stone-900">Buyer:</strong> The purchaser of goods.
                  </li>
                  <li>
                    <strong className="text-stone-900">Seller:</strong> The supplier of goods.
                  </li>
                  <li>
                    <strong className="text-stone-900">Delivery Confirmation:</strong> Digital confirmation that delivery has been
                    successfully completed.
                  </li>
                  <li>
                    <strong className="text-stone-900">Payment Service Provider (PSP):</strong> A licensed third-party entity responsible
                    for receiving, holding, and disbursing funds.
                  </li>
                </ul>
              </section>
                ...
                <div className="grid gap-6">
                  <div className="border-l-4 border-primary pl-4 py-2">
                    ...
                    <p className="text-sm mt-1">
                      Cargo must be collected within <strong>10 minutes to 8 hours</strong> after order receipt and confirmation.
                    </p>
                  </div>
                  <div className="border-l-4 border-primary pl-4 py-2">
                    <h3 className="font-bold text-stone-900">4.2 Transit Time</h3>
                    <p className="text-sm mt-1">
                      Shall follow agreed route and timeline. Variance not to exceed <strong>±10%</strong>.
                    </p>
                  </div>
                  <div className="border-l-4 border-primary pl-4 py-2">
                    <h3 className="font-bold text-stone-900">4.3 Delivery Success Rate</h3>
                    <p className="text-sm mt-1">
                      Minimum successful delivery rate: <strong>95%</strong>.
                    </p>
                  </div>
                  <div className="border-l-4 border-primary pl-4 py-2">
                    <h3 className="font-bold text-stone-900">4.4 Communication & Responsiveness</h3>
                    <p className="text-sm mt-1">
                      Emergency issues: <strong>30 minutes</strong>. Non-urgent issues: <strong>2 hours</strong>.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p>
                  Transporter is responsible for cargo from pickup to delivery. Must report incidents within <strong>1 hour</strong> via
                  TOLA.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                  ...
                  <p className="text-sm">
                    A <strong>10% fee</strong> is deducted from the transaction value for coordination, matching, and tracking services.
                    This is processed automatically via the PSP.
                  </p>
                </div>
              </section>
              ...
              <section className="space-y-4 pt-4 border-t border-stone-100">
                ...
                <div className="p-6 bg-green-50 rounded-xl border border-green-100 text-green-900">
                  ...
                  <p className="text-sm">
                    By creating an account and accepting transport orders, the Transporter legally agrees to all terms. No physical
                    signatures are required. System records constitute conclusive evidence.
                  </p>
                </div>
              </section>
            </CardContent>
