            ...
            <CardContent className="p-6 md:p-10 space-y-8 text-stone-700 leading-relaxed">
              <section className="space-y-4">
                ...
                <p>
                  ...
                  <span className="font-semibold text-stone-900">
                    Producers, Manufacturers, Suppliers, Wholesalers, Retail Traders, and Consumers
                  </span>{" "}
                  using the TOLA platform.
                </p>
              </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3 p-4 rounded-xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-sm">
                    Responsible for product quality, availability, and timely order confirmation. Failure results in order cancellation,
                    payout withholding, or account suspension.
                  </p>
                </div>
                ...
                <div className="space-y-3 p-4 rounded-xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-sm">
                    Must ensure accurate listings, timely fulfillment, and cooperation in delivery. Delays or misinformation result in
                ...
                <div className="space-y-3 p-4 rounded-xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-sm">
                    Must maintain correct pricing, confirm orders on time, and coordinate delivery. Non-compliance may lead to loss of
                    payouts or access.
                  </p>
                </div>
              ...
              <section className="space-y-4 pt-4">
                ...
                <p>Delivery confirmation is mandatory for settlement. False confirmations lead to suspension and legal action.</p>
              </section>

              <section className="space-y-4">
                <h3 className="text-xl font-bold text-stone-900">6. Payments & Commissions</h3>
                <p>All payments are processed through licensed PSPs. Commissions are deducted automatically before payout.</p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p>By registering or using TOLA, users confirm acceptance of this SLA and responsibility for their obligations.</p>
              </section>
            </CardContent>
          </Card>
        </div>
