...
import { registrationRecoverySaveSchema } from "@/lib/schemas/api"
...
export async function POST(req: NextRequest) {
  ...
  const parsed = await validateRequestBody(req, registrationRecoverySaveSchema, "registration-recovery.save")
